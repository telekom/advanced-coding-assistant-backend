...
For third party dual-licenses dependnecies, please look at [CHOSEN-LICENSES-DEPENDENCIES.md](CHOSEN-LICENSES-DEPENDENCIES.md) where we explicetly choose the licence for dual-licenced dependencies.
