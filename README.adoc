= Advanced Coding Assistant Overview
:toc: left
...
* Frontend - React application (TODO add link)
...
5. For the Frontend please take a look at our Frontend Repository and its readme found (TODO add FE link)[here]
6. Now you can start the Backend through the `ChatbotCodeMigrationApplication.java` and the React Frontend as explained in the FE readme (TODO add FE link)[here].
...
When using our (TODO add FE link)[Frontend]
