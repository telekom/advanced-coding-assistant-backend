...
import com.telekom.ai4coding.openai.model.CreateModerationRequest;
import com.telekom.ai4coding.openai.model.CreateModerationResponse;
...
@Validated
@Tag(name = "Moderations", description = "Given a input text, outputs if the model classifies it as violating OpenAI's content policy.")
