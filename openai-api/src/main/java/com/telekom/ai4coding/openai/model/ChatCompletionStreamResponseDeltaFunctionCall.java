...
@Deprecated
@Schema(name = "ChatCompletionStreamResponseDelta_function_call", description = "Deprecated and replaced by `tool_calls`. The name and arguments of a function that should be called, as generated by the model.")
