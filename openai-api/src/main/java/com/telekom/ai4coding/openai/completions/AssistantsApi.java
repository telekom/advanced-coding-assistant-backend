...
import com.telekom.ai4coding.openai.model.AssistantFileObject;
import com.telekom.ai4coding.openai.model.AssistantObject;
import com.telekom.ai4coding.openai.model.CreateAssistantFileRequest;
import com.telekom.ai4coding.openai.model.CreateAssistantRequest;
import com.telekom.ai4coding.openai.model.DeleteAssistantFileResponse;
import com.telekom.ai4coding.openai.model.DeleteAssistantResponse;
import com.telekom.ai4coding.openai.model.ListAssistantFilesResponse;
import com.telekom.ai4coding.openai.model.ListAssistantsResponse;
import com.telekom.ai4coding.openai.model.ModifyAssistantRequest;
...
public interface AssistantsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"instructions\" : \"instructions\", \"metadata\" : \"{}\", \"name\" : \"name\", \"file_ids\" : [ \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\" ], \"created_at\" : 0, \"description\" : \"description\", \"model\" : \"model\", \"id\" : \"id\", \"tools\" : [ null, null, null, null, null ], \"object\" : \"assistant\" }";
    ...
    default ResponseEntity<ListAssistantsResponse> listAssistants(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"first_id\" : \"asst_abc123\", \"data\" : [ { \"instructions\" : \"instructions\", \"metadata\" : \"{}\", \"name\" : \"name\", \"file_ids\" : [ \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\" ], \"created_at\" : 0, \"description\" : \"description\", \"model\" : \"model\", \"id\" : \"id\", \"tools\" : [ null, null, null, null, null ], \"object\" : \"assistant\" }, { \"instructions\" : \"instructions\", \"metadata\" : \"{}\", \"name\" : \"name\", \"file_ids\" : [ \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\", \"file_ids\" ], \"created_at\" : 0, \"description\" : \"description\", \"model\" : \"model\", \"id\" : \"id\", \"tools\" : [ null, null, null, null, null ], \"object\" : \"assistant\" } ], \"last_id\" : \"asst_abc456\", \"has_more\" : false, \"object\" : \"list\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
